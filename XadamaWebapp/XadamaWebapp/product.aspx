...
<body>
    ...
    <div class="shop-items">
        <div class="product-image center"> image of the product here </div>
        <div class="product-name rigth"> name of product </div>
        <div class="product-description rigth"> description of the product taken from the data base </div>
    </div>
