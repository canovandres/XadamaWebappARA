...
<form id="form1" runat="server">
    ...
    <div class="backimgh2 display-container">
        <div class="display-middle no-opacity">
            <asp:LinkButton ID="tickets" runat="server" CssClass="center button padding-medium xxlarge wide button-slice" Text="BUY TICKETS ONLY" PostBackUrl="tickets.aspx"></asp:LinkButton>
        </div>
    </div>
