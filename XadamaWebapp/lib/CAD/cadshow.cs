    ...
    class CADShow
    {
       ...
       /* ~CADShow()
        ...
        public DataTable zoneShows(String zone)
        {
            ...
            {
                if (zone!="*") {
                    SqlDataAdapter da = new SqlDataAdapter("select cod, name, description, image from show where zone like '" + zone + "'", con);
                    da.Fill(bdvirtual, "services");
                }
                else
                {
                    SqlDataAdapter da = new SqlDataAdapter("select cod, name, description, image from show", con);
                    da.Fill(bdvirtual, "services");
                }
